...
import 'color/LightColors.dart';


class AppTheme {
  const AppTheme();
  static ThemeData lightTheme = ThemeData(
    primarySwatch: LightColor.darkGreen,
    backgroundColor: LightColor.background,
    primaryColor: LightColor.darkVioleta,
    accentColor: LightColor.yellow,
    ...
    colorScheme: ColorScheme(
        primary: LightColor.violeta,
        primaryVariant: LightColor.violeta,
  ...
  static const TextStyle h2Style = const TextStyle(fontSize: 22);
